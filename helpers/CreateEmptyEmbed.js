module.exports = {
    ...
    execute(color, client, loading) {
        ...
        let embed = new Discord.RichEmbed()
            .setAuthor(client.user.username, client.user.avatarURL, "https://discord.gg/gloam")
        ...
        if (loading) {
            ...
            embed.setAuthor(client.user.username, 'https://imgur.com/2SGqVci.gif', 'https://discord.gg/gloam')
        }
        return embed;
    }
}